...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
      ...
      case 'furrylol':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/idkloolcuzlol', 'shared');
				frames = tex;
      ...
      case 'rascunhobarf':
				var tex = Paths.getSparrowAtlas('characters/barfrascunho', 'shared');
				frames = tex;
        ...
        {
          animation.addByPrefix(anim + 'miss', 'miss', 24, false);
        }
